...
1. Download the irs files and the presets.
2. Open Easy Effects
3. Import the speakers preset to output and the microphone presets to input.
5. Import the irs files in convolver effect (located in the output effects chain).
6. You can choose your preferred irs and tune the effects chain of both output and input to your liking. 
